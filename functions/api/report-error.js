  ...
  try {
    ...
    if (!isDuplicate(message)) {
      ...
      const IGNORED_SENTRY_PATTERNS = [
        ...
        // Environmental browser IndexedDB errors, surfaced async from Firebase
        // persistence. Non-actionable; the client SDK retains them downgraded in
        // beforeSend. The client window handlers already skip the homegrown
        // report for this class, so this is belt-and-suspenders.
        // KEEP IN SYNC with environmentalIdbKind() in src/lib/idbTelemetry.ts
