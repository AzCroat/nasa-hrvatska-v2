...
const CHAPTERS = [
  {
    ...
    cultural:
      'Dalmatian summers are legendary for their intensity — temperatures often exceed 35°C, yet locals carry on with markets, gardens, and family life with cheerful resilience.',
  },
  {
    id: 2,
    ...
    cultural:
      'Croatian open-air markets (tržnice) are a cornerstone of daily life. Vendors and regular customers often know each other by name, and haggling or extra generosity from sellers is a common social ritual.',
  },
  {
    id: 3,
    title: 'Poglavlje 3: Nedjeljni ručak',
    date: '29. lipnja',
    croatian: `Nedjelja je najljepši dan u tjednu. Od jutros u pet sati janje se pečelo na ražnju ispred kuće, a miris se širio cijelom ulicom — susjedi su znali što se sprema. Stigla je teta Mirjana s kruharom punim susamovih kolačića, stric Branko s bocom domaćeg vina, a mala Petra trčala je ravno u moje naručje. Stol je bio dugačak kao brodski pontoni, prekriven bijelim stolnjakom koji je moja mama vezla prije pedeset godina. Jeli smo, pričali i smijali se dok sunce nije palo iza brda. To su trenuci zbog kojih se živi.`,
    english: `Sunday is the most beautiful day of the week. Since five in the morning a lamb had been roasting on a spit in front of the house, and the smell spread down the whole street — the neighbors knew what was coming. Aunt Mirjana arrived with a bread basket full of sesame biscuits, Uncle Branko with a bottle of homemade wine, and little Petra ran straight into my arms. The table was as long as ship's pontoons, covered with the white tablecloth my mother embroidered fifty years ago. We ate, talked and laughed until the sun fell behind the hills. These are the moments that make life worth living.`,
    vocab: [
    ...
    cultural:
      'Sunday lunch (nedjeljni ručak) is the most sacred family ritual in Croatia. Spit-roasted lamb (janjetina) is a hallmark of celebrations across Dalmatia, Herzegovina, Lika, and the Croatian inland — often started before dawn and eaten in the early afternoon.',
  },
  {
    id: 4,
    ...
    cultural:
      "In Dalmatia, the sea is not just geography — it is identity. The word 'more' (sea) carries deep emotional weight, tied to memory, belonging, and the cycles of Croatian life.",
  },
  {
    id: 5,
    ...
    cultural:
      'Pašticada is the crown jewel of Dalmatian cuisine, traditionally prepared for weddings and major celebrations. Every family guards their version jealously, with secrets passed down only to trusted heirs.',
  },
  {
    id: 6,
    ...
    cultural:
      "Kolo is Croatia's ancient circle dance, listed on UNESCO's Intangible Cultural Heritage list. Fešte (feast days) tied to patron saints are still celebrated in virtually every Croatian village and neighborhood.",
  },
  {
    id: 7,
    title: 'Poglavlje 7: Pismo dijaspori',
    date: '3. kolovoza',
    croatian: `Moja mila djeco, vi koji živite u Australiji, Kanadi, Americi i Njemačkoj — pišem vam iz srca. Čujem da vaša djeca ponekad ne žele govoriti hrvatski. Razumijem — škola je na engleskom, prijatelji su na engleskom, svijet je na engleskom. Ali hrvatski je vaš dom koji nosite u sebi. Kad jednog dana dođete ovamo i čujete da neko starije kaže "Bog ti daj zdravlje" ili "Bog" na raskrižju — srce će vam se stisnuti na način koji samo mi razumijemo. Jezik je pamćenje. Jezik je grljenje bake kroz tisuće kilometara. Molim vas, ne dajte ga zaboraviti.`,
    ...
    cultural:
      'Over 1.2 million Croatians live in the diaspora worldwide. The preservation of the Croatian language across generations is a central concern for communities in Australia, Canada, the USA, Germany, and beyond.',
  },
  {
    id: 8,
    ...
    cultural:
      'Autumn ajvar-making is a beloved tradition across Croatia and the Balkans — neighbors gather to roast and grind red peppers together, and the process is as much social as culinary. Homemade ajvar is a prized gift.',
  },
  {
    id: 9,
    ...
    cultural:
      "Svi Sveti (All Saints' Day, November 1st) is one of the most observed days in Croatia. Cemeteries are illuminated with thousands of candles at dusk, creating one of the most visually striking annual traditions in the country.",
  },
  {
    id: 10,
    ...
    cultural:
      'The bura is a fierce, dry northeastern wind that sweeps down from the Dinaric Alps toward the Adriatic coast. In Dalmatia and the Kvarner region it is a cultural force — celebrated in folk sayings and feared in equal measure.',
  },
  {
    id: 11,
    ...
    cultural:
      "Fritule are Croatia's beloved Christmas doughnuts — small, fried, dusted with sugar, often flavored with lemon zest and rum. Rorate masses, held at dawn during Advent, are a deeply cherished Catholic tradition in Croatia.",
  },
  {
    id: 12,
    ...
    cultural:
      'Prošek is a traditional Dalmatian sweet wine made from dried grapes, sipped slowly and ceremonially. The Croatian diaspora numbers over 1.2 million people worldwide — their connection to language and homeland is the living heart of this app.',
  },
  {
    id: 13,
    ...
    cultural:
      "Slavonia, in eastern Croatia, is the country's agricultural heartland — flat, fertile, and famous for its food culture. Kulen is a UNESCO-recognized Slavonian sausage made with pork and hot paprika, cured over months. Fiš paprikaš, a paprika-laced fish stew cooked in a cauldron over open fire, is the region's defining dish.",
  },
  {
    id: 14,
