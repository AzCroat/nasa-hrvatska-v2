...
const RAW: Record<string, ExerciseEntry> = {
  ...
  argumentacija: g('gc', 'grammar', 'grammar'),
  ograde: g('gc', 'grammar', 'grammar'),
  apstraktno: g('gc', 'grammar', 'grammar'),
  registri: g('gc', 'grammar', 'grammar'),
  izlaganje: g('gc', 'grammar', 'grammar'),
  sastanci: g('gc', 'grammar', 'grammar'),
  poslovno: g('gc', 'grammar', 'grammar'),
  politika: g('gc', 'grammar', 'grammar'),
  caskanje: g('gc', 'grammar', 'grammar'),
  humor: g('gc', 'grammar', 'grammar'),
  povijestjezika: g('gc', 'grammar', 'grammar'),
  knjizevnost: g('gc', 'grammar', 'grammar'),
  cestice: g('gc', 'grammar', 'grammar'),
  debata: g('gc', 'grammar', 'grammar'),
  govor: g('gc', 'grammar', 'grammar'),
  prevodjenje: g('gc', 'grammar', 'grammar'),
  lektura: g('gc', 'grammar', 'grammar'),
  analizamedija: g('gc', 'grammar', 'grammar'),
  pravo: g('gc', 'grammar', 'grammar'),
  znanost: g('gc', 'grammar', 'grammar'),
  umjetnost: g('gc', 'grammar', 'grammar'),
  regionalizmi: g('gc', 'grammar', 'grammar'),
  identitet: g('gc', 'grammar', 'grammar'),
  dijaspora: g('gc', 'grammar', 'grammar'),
  norma: g('gc', 'grammar', 'grammar'),
  sklonidbaizn: g('gc', 'grammar', 'grammar'),
  brojevinorma: g('gc', 'grammar', 'grammar'),
  slaganjec2: g('gc', 'grammar', 'grammar'),
  padezisupt: g('gc', 'grammar', 'grammar'),
  naciniobveze: g('gc', 'grammar', 'grammar'),
  ritam: g('gc', 'grammar', 'grammar'),
  ironija: g('gc', 'grammar', 'grammar'),
  humorjezik: g('gc', 'grammar', 'grammar'),
  knjizevni: g('gc', 'grammar', 'grammar'),
  staritekstovi: g('gc', 'grammar', 'grammar'),
  rekonstrukcija: g('gc', 'grammar', 'grammar'),
  spontano: g('gc', 'grammar', 'grammar'),
  prevodjenjestr: g('gc', 'grammar', 'grammar'),
  frazemi: g('gc', 'grammar', 'grammar'),
  dijalektic2: g('gc', 'grammar', 'grammar'),
  jezikdrustvo: g('gc', 'grammar', 'grammar'),
  persiranje: g('gc', 'grammar', 'grammar'),
  prijedlozia2: g('gc', 'grammar', 'grammar'),
  slaganjea2: g('gc', 'grammar', 'grammar'),
  prilozia2: g('gc', 'grammar', 'grammar'),
  veznici: g('gc', 'grammar', 'grammar'),
  kojia2: g('gc', 'grammar', 'grammar'),
  neodredjenea2: g('gc', 'grammar', 'grammar'),
  trajanje: g('gc', 'grammar', 'grammar'),
  polozaj: g('gc', 'grammar', 'grammar'),
  stvarniuvjeti: g('gc', 'grammar', 'grammar'),
  zaljenje: g('gc', 'grammar', 'grammar'),
  modalninijanse: g('gc', 'grammar', 'grammar'),
  dvopadezni: g('gc', 'grammar', 'grammar'),
