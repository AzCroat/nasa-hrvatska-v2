...
export const EXERCISE_DIFFICULTY: Record<string, number> = {
  ...
  meteo: 2,
  svidjanje: 2,
  // A2 topical block: tier 3, matching the other A2 banks.
  dom: 3,
  zdravlje: 3,
  odjeca: 3,
  izgled: 3,
  ...
  dogovor: 3,
  blagdani: 3,
  // B1 topical block: tier 4, matching the other B1 banks.
  misljenje: 4,
  osjecaji: 4,
  zalbe: 4,
  salter: 4,
  ...
  priroda: 4,
  kuhanje: 4,
  // B2 functional block: tier 5, matching the other B2 banks.
  argumentacija: 5,
  ograde: 5,
  apstraktno: 5,
  registri: 5,
