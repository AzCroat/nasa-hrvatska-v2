...
async function main() {
  ...
  const CORE_KEYS = ['V','COUNTRIES','PROFESSIONS','WEATHER','CLOTHES','BODYDESC','TECH_VOC','BUREAUCRATIC','PROVERBS','IDIOMS','BRZALICE','HISTORY','EVENTS','KINGS','REGIONS','DIALECTS','CROATIAN_CITIES','FOODORDER','TRANSPORT','GROCERY','RECIPES','PRACTICAL','SCENES','LEVEL_NARRATIVE','SHADOWING','LEARN_PATH','SEASONAL_CAMPAIGNS','V_B2','V_C1','V_C2','CULTURE_DEEP_DIVES'];
  const coreExports = {};
